<form class="filters-form" method="get" data-auto="<?= wc_bool_to_string($instance['auto']) ?>"
                    ...
                    <div class="filter-block-content">
                        ...
                        <div class="inputs price range" data-mode="<?= $data['type'] ?>">
                            <?php if ($data['type'] != 'ranges') { ?>
                                <div class="group">
                                    <input type="number" data-label="Мин. цена" data-type="min"
                                ...
                                <div class="group">
                                    <input type="number" data-label="Макс. цена" data-type="max"
            ...
            if ($vc > 0) {
                ...
                <div class="filter-block<?= $opened ?>">
                    <div class="filter-block-header">
                        ...
                        <!--                <div class="filter-block-counter"></div>-->

                        <div class="filter-block-toggler">
                            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14"
                                 fill="none">
                                <path d="M11.0832 5.24992L6.99984 9.33325L2.9165 5.24992" stroke="#5F6467"
                                    ...
                                    <label class="group-label" for="<?= $vid ?>">
                                        <span class="indicator">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15"
                                                ...
                                                <path d="M4 7.50002L6.33348 10L11 5" stroke="#34A0E1" stroke-width="1.5"
    ...
    <?php if (!$instance['auto']) { ?>
        <div class="buttons">
            <button class="button btn primary" type="submit" value="filter">Применить</button>

            <button class="button p3" type="reset" value="filter">Очистить фильтры</button>
        </div>
    <?php } ?>
</form>