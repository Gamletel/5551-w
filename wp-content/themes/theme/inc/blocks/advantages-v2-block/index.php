...
class AdvantagesV2Block
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'advantages-v2-block',
				'title'             => 'Блок: Преимущества V2',
				'description'       => 'Преимущества V2',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/advantages-v2-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/advantages-v2-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
