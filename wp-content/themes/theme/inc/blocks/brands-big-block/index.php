...
class BrandsBigBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'brands-big-block',
				'title'             => 'Блок: Бренды (большой)',
				'description'       => 'Большой блок с брендами',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/brands-big-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/brands-big-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
