...
class PayAndDeliveryBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'pay-and-delivery-block',
				'title'             => 'Блок: Оплата и доставка',
				'description'       => 'Блок с информацией о доставке и оплате',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/pay-and-delivery-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/pay-and-delivery-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
...
return new PayAndDeliveryBlock();
?>