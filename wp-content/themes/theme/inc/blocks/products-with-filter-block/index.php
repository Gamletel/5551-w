...
class ProductsWithFilterBlock
{
	...
	public function _register()
	{
		acf_register_block_type(
			array(
				'name'              => 'products-with-filter-block',
				'title'             => 'Блок: Товары (с фильтром)',
				'description'       => 'Товары с фильтром и пагинацией',
				// 'post_types'        => array(),
	...
	public function _enqueue_assets()
	{
		...
		wp_enqueue_style('theme/products-with-filter-block',GSE()::theme_uri().$path.'/block.css',array(),2);
		wp_enqueue_script('theme/products-with-filter-block',GSE()::theme_uri().$path.'/block.js',array(),2);
		return;
	}
...
return new ProductsWithFilterBlock();
?>