...
//        }
                ...
                <div class="close-subcats">
                    <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                        <g clip-path="url(#clip0_528_41776)">
                            <path d="M11.0518 0L7 4.05177L2.94823 0L0 2.94823L4.0518 7L0 11.0518L2.9482 14L7 9.9482L11.0518 14L14 11.0518L9.9482 6.99997L14 2.9482L11.0518 0Z" fill="#C9CCCE"/>
                        </g>
                        <defs>
   ...
   <?php }
        ...
        <div class="product-card__bottom">
            <?php if ($additional_attributes) { ?>
                <div class="additional-attributes">
                    ...
                    <div class="additional-attributes__bottom">
                        <?php foreach ($additional_attributes as $key => $item) {
                            $icon = wp_get_attachment_image_url($item['icon'], 'full');
                            $value = $item['value'];
                            ?>
            ...
            <div class="product-card__price">
                ...
                <a href="<?= $product_link; ?>" class="product-link btn">
                    <?= inline('assets/images/arrow.svg'); ?>
                </a>
            </div>
        </div>
    ...
    public function custom_product_swiper()
    {
        ...
        <div class="product-swipers">
                ...
                <div class="swiper-wrapper">
                    <?php if ($thumbnail) { ?>
                        <div class="swiper-slide">
                            <img src="<?= $thumbnail; ?>" data-fancybox='gallery' data-src='<?= $thumbnail; ?>' alt="">
                        </div>
                    <?php } ?>
            ...
            <div class="thumbs-swiper-wrapper">
                <div class="swiper-mini-btn-prev">
                    <?= inline('assets/images/mini-arrow.svg'); ?>
                </div>
                ...
                <div class="swiper-mini-btn-next">
                    <?= inline('assets/images/mini-arrow.svg'); ?>
                </div>
            </div>
        </div>
    ...
    public function top_row()
    {
        ...
        <div class="top-row">
            <?php if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ) : ?>
                <span class="sku_wrapper p3"><?php esc_html_e( 'SKU:', 'woocommerce' ); ?> <span class="sku p3"><?php echo ( $sku = $product->get_sku() ) ? $sku : esc_html__( 'N/A', 'woocommerce' ); ?></span></span>
            <?php endif; ?>
    ...
    {
        echo '<a href="' . esc_url(add_query_arg('empty_cart', 'yes')) . '" class="link link-main-text" title="' . esc_attr('Empty Cart', 'woocommerce') . '"><svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 10 10" fill="none">
  <g clip-path="url(#clip0_240_32046)">
    <path d="M7.89414 0L5 2.89412L2.10588 0L0 2.10588L2.89414 5L0 7.89412L2.10586 9.99998L5 7.10586L7.89414 10L10 7.89412L7.10586 4.99998L10 2.10586L7.89414 0Z" fill="var(--Main-text)"/>
  </g>
  <defs>
    <clipPath id="clip0_240_32046">
...
Очистить корзину
    ...
    public function custom_checkout_order_review()
    {
        ...
        <div class="cart-products-count">
            ...
            <div class="p2 count__number"><?= WC()->cart->get_cart_contents_count() ?></div>
        </div>
        <?php
    }
