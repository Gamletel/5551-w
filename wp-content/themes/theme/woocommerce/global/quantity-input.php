    ...
    <div class="quantity">
        ...
        <button class="quantityDown <?php if ($input_value == 1) { ?>quantity-disabled<?php } ?>" type="button"
            ...
            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
                <rect x="19" y="28" width="2" height="16" transform="rotate(-90 19 28)" fill="#E6E6E6"/>
            </svg>
        </button>

        <label class="screen-reader-text" for="<?php echo esc_attr($input_id); ?>"><?php echo esc_attr($label); ?></label>

        <input style="display: none;" type="number" id="input-<?php echo esc_attr($input_id); ?>"
        ...
        <span class="p2 product-amount" id="<?php echo esc_attr($input_id); ?>"><?php echo esc_attr($input_value); ?></span>

        <button class="quantityUp" type="button" onclick="cChangeValue('<?php echo esc_attr($input_id); ?>',0);">
            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54" viewBox="0 0 54 54" fill="none">
                <rect x="25.9336" y="19" width="2.13333" height="16" fill="#34A0E1"/>
                <rect x="19" y="28.0667" width="2.13333" height="16" transform="rotate(-90 19 28.0667)" fill="#34A0E1"/>
            </svg>
        </button>
